...
Class Usuario
{
	...
	//Implementar un método para listar los usuarios por cargo
	...
	//Implementar un método para listar los encargados de produccion
	public function selectPlanta()
	{
		$sql="SELECT * FROM usuario WHERE condicion='1' AND cargo='Planta'";
		return ejecutarConsulta($sql);
	}
